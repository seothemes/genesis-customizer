jQuery(document).ready(function ($) {
    ...
    $('#select-all').on('click', function () {
        var checkBoxes = $('.checkbox_multi input');
    ...
    $('.tooltip-toggle').on('click', function () {
        var tooltip = $(this).closest('td').find('.tooltip');

        tooltip.fadeToggle();
    });

    $('.typekit-custom-fonts-wrap .meta-box-sortables:nth-of-type(2) .panel-inner p:first-of-type').html('hello');
